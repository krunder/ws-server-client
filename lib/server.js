  ...
  onMessage(client, msg) {
    try {
      ...
      if (!payload.type || typeof payload.type !== 'string') {
        return (new Response({}, 'type-required')).toClient();
      }

      if (!payload.name || typeof payload.name !== 'string') {
        return (new Response({}, 'name-required')).toClient();
      }
      ...
      if (payload.type === 'event') {
        ...
        if (!this.channels[name]) {
          return (new Response({}, 'invalid-channel')).toClient();
        }
        ...
        return (new Response({}, 'invalid-mode')).toClient();
      }
    } catch (e) {
