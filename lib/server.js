...
class Server {
  ...
  start() {
    ...
    this.httpServer.on('upgrade', (request, socket, head) => {
      this.wssServer.handleUpgrade(request, socket, head, (client) => this.onUpgrade(client, request));
    });
  ...
  onUpgrade(client, request) {
    ...
    this.wssServer.emit('connection', client, request);
  };
